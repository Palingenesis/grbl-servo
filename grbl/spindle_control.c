...
/*
    ...
    Start = 0.000512  second. So 0.000512  / 0.000064 = 8.0
    End   = 0.0024896 second. So 0.0024896 / 0.000064 = 38.9

    The above example is for a cheap SG90 with plastic gears.

*/

#define RC_SERVO_SHORT      8.0                                 /* RC Servo */
#define RC_SERVO_LONG       38.9                                /* RC Servo */
...
#ifdef RC_SERVO_SHORT                                                                                                           /* RC Servo */
#ifdef RC_SERVO_INVERT                                                                                                        /* RC Servo */
        pwm_value = floor((settings.rpm_max - rpm) * (RC_SERVO_RANGE / (settings.rpm_max - settings.rpm_min)) + RC_SERVO_SHORT);    /* RC Servo */
#else                                                                                                                         /* RC Servo */
